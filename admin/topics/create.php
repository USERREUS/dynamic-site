...
<head>
  <meta charset="UTF-8">
  <title>Admin topics create page</title>
          ...
          <form action="create.php" method="post" enctype="multipart/form-data">
            <div>
              <div class="inp-box">
                ...
                <input name="name" type="text" class="inp" id="title" placeholder="Заголовок поста" required>
              </div>
              <div class="inp-box">
                <label for="editor" class="form-label">Описание</label>
                <textarea name="description" class="inp" id="editor"></textarea>
              </div>
            </div>
            <hr>
            <ul class="c4">
              <li><button name="topic-create" type="submit">Создать новую категорию</button></li>
